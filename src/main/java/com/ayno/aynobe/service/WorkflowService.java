...
public class WorkflowService {
    ...
    private void validateUniqueNumbers(WorkflowCreateRequestDTO dto) {
    ...
    private Map<Long, Tool> preloadToolsById(WorkflowCreateRequestDTO dto) {
